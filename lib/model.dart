class webview {
  ...
  List<webview> bhargav() {
    ...
    webview SPSS = webview(
        Url: "https://www.it-services.ruhr-uni-bochum.de/mam/images/logos/software/spss.png",
    ...
    webview RProgramming = webview(
        Url: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/R_logo.svg/2560px-R_logo.svg.png",
        info:
    ...
    webview PythonTurtle = webview(
      Nameint: "Python Turtle Programming",
        info: "Turtle is a Python library which used to create graphics, pictures, and games. It was developed by Wally Feurzeig, Seymour Parpet and Cynthina Slolomon in 1967. It was a part of the original Logo programming language."
  ...
  List<webview> wiki4 (){
    ...
    webview wikimediacommon = webview(
      ...
      Image: "https://www.wikimedia.fr/wp-content/uploads/2017/04/Stickers-Commons.png",
      info: "photos & more",
    );
    webview wikimediacommon1 = webview(
      Name: "wikivoyage",
      Nameint: "Free travel guide",
      Image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Wikivoyage-logo.svg/2048px-Wikivoyage-logo.svg.png",
      info: "",
    );
    webview wikimediacommon2 = webview(
      Name: "Wiktionary",
      Nameint: "Free dictionary",
      Image: "https://p7.hiclipart.com/preview/939/8/920/wiktionary-wikimedia-foundation-html-others.jpg",
      info: "",
    );
    webview wikimediacommon3 = webview(
      Name: "Wikibooks",
      Nameint: "Free textbooks",
      Image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Wikibooks-logo-background.png/720px-Wikibooks-logo-background.png",
      info: "",
    );
    webview wikimediacommon4 = webview(
      Name: "Wikinews",
      Nameint: "Free news source",
      Image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Wikinews-logo.svg/1200px-Wikinews-logo.svg.png",
      info: "",
    );
    webview wikimediacommon5 = webview(
      Name: "Wikidata",
      Nameint: "Free knowledge",
      Image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Wikidata-logo.svg/2560px-Wikidata-logo.svg.png",
      info: "base",
    );
