...
import 'package:webapp/inappwebview.dart';
import 'package:webapp/javatpiont.dart';
import 'package:webapp/model.dart';
import 'package:webapp/splunk.dart';
import 'package:webapp/wikiinfo.dart';
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Container(
                ...
                child: Image(image: NetworkImage("https://upload.wikimedia.org/wikipedia/en/thumb/8/80/Wikipedia-logo-v2.svg/1200px-Wikipedia-logo-v2.svg.png")),
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    child: Text("The Free Encylopedia",
                      style: TextStyle(
                          fontSize: MediaQuery.of(context).size.height * 0.02
                      ),),
                  )
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Center(
                  child: Text("Read Wikipedia in your language",
                    style: TextStyle(
                        color: Colors.blue,
                      fontSize: MediaQuery.of(context).size.height*0.02
                    ),
          ...
          Container(
            ...
            child: Image(
              image: NetworkImage("https://wikimediafoundation.org/wp-content/uploads/2018/08/Wikimedia-logo_black.png"),
            ),
          ),
          Container(
            margin: EdgeInsets.only(top: 10),
  ...
  Widget Gridview2(List<webview> b,Color color) {
    return GridView.count(
        ...
        children: b.map((e) {
          return InkWell(
            onTap: (){
              Navigator.of(context).push(MaterialPageRoute(builder: (context)=> Language(e)));
            },
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
